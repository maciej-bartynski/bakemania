...
const LOG_LOCATION_APP = 'test-integration-auth-register-logs-app';
const LOG_LOCATION_WS = 'test-integration-auth-register-logs-ws';
const LOG_LOCATION_EMAIL = 'test-integration-auth-register-logs-email';
const LOG_LOCATION_CLIENT = 'test-integration-auth-register-logs-client';
